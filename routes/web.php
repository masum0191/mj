...
Route::get('sales/gen_invoices/{id}', [SaleController::class,'genInvoice']);
// Auto Update
...
Route::group(['middleware' => ['common', 'auth', 'active']], function() {
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::post('whatsapp','whatsapp')->name('whatsapp.post');
    ...
    Route::controller(BillerController::class)->group(function () {
        ...
        Route::get('biller/setelment', 'billerPaymentList');
        Route::get('biller/receive/{id}', 'biller_receive');
        Route::get('biller/adminsetelment', 'admin_setelment');
        Route::post('biller/adminpayment', 'adminpayment');
    });
    ...
    Route::controller(ReportController::class)->group(function () {
        Route::prefix('report')->group(function () {
            ...
            Route::get('multiple-dates', 'showMonthlyReport')->name('report.monthly_report');
